...
public class TestDroneEntityModel extends EntityModel<TestDroneEntity> {
    ...
    public TestDroneEntityModel(ModelPart model){
    ...
    @Override
    public void setAngles(TestDroneEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
    ...
    @Override
    public void animateModel(TestDroneEntity entity, float limbAngle, float limbDistance, float tickDelta) {
