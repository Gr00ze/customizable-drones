...
public class TestDroneEntityRenderer extends EntityRenderer<TestDroneEntity> {
    ...
    private final TestDroneEntityModel model;
    public TestDroneEntityRenderer(EntityRendererFactory.Context ctx) {
        super(ctx);
        this.model = new TestDroneEntityModel(ctx.getPart(DRONE_LAYER));
    }

    @Override
    public Identifier getTexture(TestDroneEntity entity) {
        return TEXTURE;
    }
    ...
    public void render(TestDroneEntity entity, float yaw, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light) {
